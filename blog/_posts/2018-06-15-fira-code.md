...
[Hasklig](https://github.com/i-tu/Hasklig/), announced in 2014, was probably the first code font that used ligatures in the font to replace Haskell [ASCII art](https://en.wikipedia.org/wiki/ASCII_art) with proper mathematical symbols.
